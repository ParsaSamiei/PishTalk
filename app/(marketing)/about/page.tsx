...
export const metadata: Metadata = {
  title: "درباره ما",
  description: "درباره پیشتاک و باشگاه رباتیک پیشنام.",
    ...
    <Section className="pt-12" circuit>
      <Container className="mx-auto flex max-w-3xl flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 leading-relaxed text-text-secondary">
          <p>
            پیشتاک رویداد ماهانه‌ای است که توسط باشگاه رباتیک پیشنام برگزار
          ...
          <p>
            پیشتاک بخشی از فعالیت‌های آموزشی و اجتماعی باشگاه رباتیک پیشنام است
            که در زمینه آموزش رباتیک، برگزاری مسابقات و توسعه تیم‌های دانشگاهی
            فعالیت می‌کند.
          </p>
        </div>
